...
DROP TABLE FREE_RECOMMENT CASCADE CONSTRAINTS;
...
CREATE TABLE Member (
    ...
    M_DATE TIMESTAMP DEFAULT SYSDATE,
...
ALTER TABLE FREE_Recomment ADD CONSTRAINT PK_FREE_RECOMMENT PRIMARY KEY (
	R_NO,
	B_NO
);
...
ALTER TABLE FREE_RECOMMENT ADD CONSTRAINT FK_FREE_TO_FREE_RECOMMENT_1 FOREIGN KEY (
	B_NO
)
REFERENCES FREE (
	B_NO
...
ALTER TABLE FREE_RECOMMENT ADD CONSTRAINT FK_Member_FREE_COMMENT FOREIGN KEY (
	M_ID
)
REFERENCES Member (
	M_ID
...
--시퀀스
DROP SEQUENCE SEQUENCE_FREE_B_NO;
DROP SEQUENCE SEQUENCE_FREE_R_NO;
DROP SEQUENCE SEQUENCE_STORY_B_NO;
DROP SEQUENCE SEQUENCE_STORY_R_NO;
DROP SEQUENCE SEQUNECE_CART_C_NO;
DROP SEQUENCE SEQUENCE_CART_P_SEQ;
DROP SEQUENCE SEQUENCE_PROD_DETAIL_P_SEQ;
DROP SEQUENCE SEQUENCE_PROD_DETAIL_P_NO;
DROP SEQUENCE SEQUENCE_ORDER_DETAIL_NO;
DROP SEQUENCE SEQUENCE_ORDER_DETAIL_P_SEQ;
DROP SEQUENCE SEQUENCE_ORDERS_O_NO;
DROP SEQUENCE SEQUENCE_PRODUCT_P_NO;
DROP SEQUENCE SEQUENCE_PRODUCT_IMG_P_NO;


CREATE SEQUENCE SEQUENCE_FREE_B_NO
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;

CREATE SEQUENCE SEQUENCE_FREE_R_NO
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;
...
CREATE SEQUENCE SEQUENCE_CART_P_SEQ
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;

CREATE SEQUENCE SEQUENCE_PROD_DETAIL_P_SEQ
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;

CREATE SEQUENCE SEQUENCE_PROD_DETAIL_P_NO
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;

CREATE SEQUENCE SEQUENCE_ORDER_DETAIL_NO
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;

CREATE SEQUENCE SEQUENCE_ORDER_DETAIL_P_SEQ
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;

CREATE SEQUENCE SEQUENCE_ORDERS_O_NO
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;

CREATE SEQUENCE SEQUENCE_PRODUCT_PNO
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;

CREATE SEQUENCE SEQUENCE_PRODUCT_IMG_P_NO
START WITH 1 INCREMENT BY 1 NOCYCLE NOCACHE;
