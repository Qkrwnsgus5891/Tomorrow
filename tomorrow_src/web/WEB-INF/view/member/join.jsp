    ...
    <form action="join" method="post" id="regfrm">
    	<div class="con">
        	...
        	<div class="div">
        		...
        		<input type="password" name="password" id="password" class="input" required placeholder="비밀번호"><br>
        	</div>
        	<div class="div">
	        	<label class="bold2">비밀번호 확인</label><br>
        		<input type="password" name="passwordRe" id="passwordRe" class="input" required placeholder="비밀번호 확인"><br>
        	</div>       
        	...
        	<div class="div">        
        	<button type="button" id="enrollBtn" class = "btn2">회원가입하기</button>
        		<div class="bottom">
