...
<body>
	...
	<form name="oderFinal" id="join" onsubmit="return validate();">
		...
		<div id="cartWrap" style="display: flex; margin: 0 10% 0 10%">
			<div id="orderWrap"
				...
				<table border=0 style="text-align: left;">
					...
					<tr>
						...
						<td colspan="2"><input type="text" placeholder="핸드폰 번호 입력" 
							name="oPhone" id="phoneRest" class="textbox" value="${vo.mPhone}"
							 style="height: 25px; width: 200px; margin-left: 20px;"></td>
				...
				<table border=0 style="text-align: left;">
					<tr>
						<td>배송지명</td>
						<td colspan="2"><input type="text" class="textbox" id="oRecieverAddress2"
							style="height: 25px; width: 200px; margin-left: 20px;"></td>
					</tr>
					<tr>
						<td>받는사람</td>
				...
				<div <c:set var="setOpt" value="${pdOpt.optNo }"></c:set>
					...
					<div style="width: 100%;">
						<input type="checkbox" id="allcheck"
							style="height: 15px; width: 15px;"> 아래 내용에 모두 동의합니다. (필수)

						<br> <br> <input type="checkbox" class="check" required
							style="height: 15px; width: 15px;"><span id="agree01"
							style="cursor: pointer;"> 개인정보 수집 허용 및 제 3자 제공 동의
							&nbsp;&nbsp;▼</span><br>
