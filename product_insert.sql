...
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '아엠홈', '[주말특가][맞춤] 비침없는 화이트 도톰 레이스/쉬폰커튼(나비주름/핀형/봉집)', '<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c1_1.jpg" /></p>', 19900, 2);
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '헬로우슬립', '부드러운 카스테라 항균 옥수수솜 봄이불 차렵이불세트',  '<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c2_1.jpg" /></p>', 37900, 2);
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '코튼리빙', '40수 코마사 호텔수건 200g 10장',  '<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c3_1.jpg" /></p>', 28500, 2);

insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '티피링크', 'Tapo L530E 스마트 멀티 컬러 전구 IoT LED 조명',  '<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/light_c1_1.jpg" /></p>', 14000, 3);
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '에이모노', '빈티지 레트로 스탠드_4types', '<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/light_c2_1.jpg" /></p>', 29900, 3);
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '레나에너지', '우주인 오로라 무드등 은하수 조명 LN-777', '<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/light_c3_1.jpg" /></p>', 22800, 3);
...
insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 1, 'upload/images/product/detail/furniture_d1.jpg', 124);
insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 2, 'upload/images/product/detail/furniture_d2.jpg', 124);
insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 3, 'upload/images/product/detail/furniture_d3.jpg', 124);

insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 4, 'upload/images/product/detail/fabric_d1.jpg', 124);
insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 5, 'upload/images/product/detail/fabric_d2.jpg', 124);
insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 6, 'upload/images/product/detail/fabric_d3.jpg', 124);

insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 7, 'upload/images/product/detail/light_d1.jpg', 124);
insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 8, 'upload/images/product/detail/light_d2.jpg', 124);
insert into product_img values (SEQUENCE_PRODUCT_IMG_NO.nextval, 9, 'upload/images/product/detail/light_d3.jpg', 124);
commit;

-- 색상/사이즈/추가상품 (1/2/3)
-- furniture 4
insert into product values(SEQUENCE_PRODUCT_P_NO.nextval, '오트밀하우스', '[오집배송] 인기 급증 BEST 침대/소파/식탁/서랍장/거울/드레스룸/거실장 모음전', 
'<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c4_1.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c4_2.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c4_3.jpg" /></p>
', 155000, 1);
...
-- furniture 5
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '퀵슬립', 'Q4 유로탑 롤팩 매트리스 2size', 
'<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c5_1.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c5_2.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c5_3.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c5_4.jpg" /></p>
', 284900, 1);
...
-- furniture 6
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '큐브', '[드레스룸BEST] 맞춤제작 시스템 드레스룸 (시공무료) 9colors', 
'<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c6_1.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/furniture_c6_2.jpg" /></p>
', 8200, 1);
...
-- fabric 4
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '마틸라', '최고급 코마사 도즈60수 고밀도순면 차렵이불세트10color', 
'<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c4_1.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c4_2.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c4_3.jpg" /></p>
', 61900, 2);
...
-- fabric 5
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '마틸라', '복숭아촉감 보드라운 피치스킨 먼지없는 차렵이불(세트) 10colors', 
'<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c5_1.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c5_2.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c5_3.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c5_4.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c5_5.jpg" /></p>
', 35500, 2);
...
-- fabric 6
insert into product values (SEQUENCE_PRODUCT_P_NO.nextval, '심플먼트', '셀프 DIY 방염 타일카페트 (50x50cm) 8P/16P', 
'<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c6_1.jpg" /></p>
<p><img alt="" src="http://localhost:8090/house/upload/images/product/content/fabric_c6_2.jpg" /></p>
', 29900, 2);
